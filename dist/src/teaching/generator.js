...
export function buildPrompt(event, knowledge, recentSteps, depth = 2, lang = "auto", goal = "", projectType = "auto") {
    ...
    const knowledgeSection = weakConcepts.length > 0
        ? [
...
export async function generateTeaching(client, event, knowledge, recentSteps, model = "claude-sonnet-4-6", depth = 2, lang = "auto", goal = "", projectType = "auto") {
